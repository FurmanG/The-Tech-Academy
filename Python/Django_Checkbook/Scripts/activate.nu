...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\Gil\Documents\Tech Academy\Python-projects-2\Django_Checkbook'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\Gil\Documents\Tech Academy\Python-projects-2\Django_Checkbook\Scripts\deactivate.nu'
